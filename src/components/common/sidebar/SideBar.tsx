...
export const SideBar: React.FC<{ children: ReactNode }> = ({ children }) => {
    ...
    return (
        <aside
            ...
            } z-50  gap-2 border-r border-primary-500 border-opacity-40 bg-white`}
            ref={SIDE_BAR_ELEMENT}
        >
            <div className="h-full w-full bg-primary-500 bg-opacity-30 px-4 ">
                ...
                <div className="h-20">
                    <button
                        className="flex items-center gap-3 font-medium text-primary-500"
                        onClick={logout}
                    >
                        <LogoutSVG />
                        <span>Log Out</span>
